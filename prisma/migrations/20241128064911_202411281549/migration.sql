...
CREATE TABLE "user" (
    ...
    "is_using_account" BOOLEAN NOT NULL DEFAULT true,
...
-- AddForeignKey
ALTER TABLE "board_comment" ADD CONSTRAINT "board_comment_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "account_using_querylog" ADD CONSTRAINT "account_using_querylog_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "user"("id") ON DELETE SET NULL ON UPDATE CASCADE;
